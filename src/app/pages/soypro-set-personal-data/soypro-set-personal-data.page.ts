...
@Component({
  ...
  templateUrl: './soypro-set-personal-data.page.html',
  styleUrls: ['./soypro-set-personal-data.page.scss'],
})
export class SoyproSetPersonalDataPage implements OnInit {
  avatar: string;
  form: FormGroup;
  ...
  async submit () {
    ...
    await this.storage.setObject ("pro_user_data", value);
    await this.storage.setValue ("pro_user_avatar", value.avatar);
